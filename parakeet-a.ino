...
// 1 - Неверный CRC в сохраненных настройках. Берем настройки по умолчанию
// 2 - Не подключен модем.
// 3 - Нет мобильной связи
...
void init_GSM() {
  ...
  gsm_availible = gsm_command("AT+CFUN=1,1", "Call Ready", 30); // Подключаемся к сети  
